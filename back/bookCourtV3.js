...
const bookCourtV2 = async (
  ...
  const titleVariations = [`${park} - Tennis #${courtNumber} (Lights) ${timeSlot1} Available`, `${park} - Tennis #${courtNumber} ${timeSlot1} Available`, `${park} - Tennis # ${courtNumber} ${timeSlot1} Available`, `${park} - Tennis # ${courtNumber} (Lights) ${timeSlot1} Available`];
  let success = false;
  ...
  const titleVariations2 = [`${park} - Tennis #${courtNumber} (Lights) ${timeSlot2} Available`, `${park} - Tennis #${courtNumber} ${timeSlot2} Available`, `${park} - Tennis # ${courtNumber} ${timeSlot2} Available`, `${park} - Tennis # ${courtNumber} (Lights) ${timeSlot2} Available`];
  let success2 = false;
  for(let variation in titleVariations2){
    try{
      await page.click(`div[aria-label="${titleVariations2[variation]}"]`);
      success2 = true;
      break;
    }catch(e){
      console.log(e);
